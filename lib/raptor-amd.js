...
function registerCommonJSModule(id) {
    ...
    raptorModulesClient.main(realPath, "index");
    realPath += '/index';
    ...
    raptorModulesClient.def(realPath, function(require, exports, module, __filename, __dirname) {
        ...
        var instance = isFunction(factory) ? factory.apply(this, dependencies.concat([require, exports, module])) : factory;
        var o;
 ...
 * @private
 */
function _define(args, isExtend, isClass, isEnum) {
    var i=0;
